...
#       ifdef _WIN64
#           pragma comment(lib, "0 LiteAntTweakBarStatic64")
#       else
#           pragma comment(lib, "0 LiteAntTweakBarStatic")
#       endif
#   endif
#else
...
#   if defined(_MSC_VER) && !defined(TW_NO_LIB_PRAGMA)
#       ifdef _WIN64
#           pragma comment(lib, "0 LiteAntTweakBar64")
#       else
#           pragma comment(lib, "0 LiteAntTweakBar")
#       endif
#   endif
#endif
...
// CUSTOM
TW_API int			TW_CALL TwLoaded(void);
TW_API void			TW_CALL TwHideBar(TwBar *bar, int hidden);
TW_API int			TW_CALL TwBarHidden(const TwBar *bar);
TW_API void			TW_CALL TwMinimizeBar(TwBar *bar, int minimized);
TW_API int			TW_CALL TwBarMinimized(const TwBar *bar);
...
#endif  // _W64
#ifdef _WIN64
    TW_API int  TW_CALL TwEventWin(HWND wnd, unsigned int msg, unsigned __int64 _W64 wParam, __int64 _W64 lParam);
#else
    TW_API int  TW_CALL TwEventWin(HWND wnd, unsigned int msg, unsigned int _W64 wParam, int _W64 lParam);
#endif
