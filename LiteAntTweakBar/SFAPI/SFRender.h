...
#define FCR_SHADOW		0x8
#define FCR_UNDERLINE	0x10
#define FCR_STRIKEOUT	0x20
...
struct API stFontInfo
{
	...
	HRESULT Print( const char *text, D3DCOLOR color, float x, float y, bool skipColorTags = false, bool ignoreColorTags = false, frect rect = frect( -1.0f, -1.0f, -1.0f, -1.0f ) );
	HRESULT PrintShadow( const char *text, D3DCOLOR color, float x, float y, bool skipColorTags = false, bool ignoreColorTags = false, frect rect = frect( -1.0f, -1.0f, -1.0f, -1.0f ) );
