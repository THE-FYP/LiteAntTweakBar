...
int TW_CALL TwEventWin(HWND wnd, unsigned int msg, unsigned PARAM_INT _W64 wParam, PARAM_INT _W64 lParam)
{
    int handled = 0;
...
extern "C" {
#endif  // __cplusplus
TW_EXPORT_API int TW_CALL TwEventWin32(HWND wnd, unsigned int msg, unsigned int _W64 wParam, int _W64 lParam)
{
